...
class Settings extends MY_Controller{
    ...
    public function save(){
        ...
        if($validate){
            ...
            $image_212x50 = upload_picture($_FILES["logo"]["tmp_name"], "uploads/$this->viewFolder",212,50, $file_name);
            $image_170x40 = upload_picture($_FILES["mobile_logo"]["tmp_name"], "uploads/$this->viewFolder",170,40, $file_name);
            $image_32x32  = upload_picture($_FILES["favicon"]["tmp_name"], "uploads/$this->viewFolder",32,32, $file_name);
            if($image_212x50 && $image_170x40 && $image_32x32){
