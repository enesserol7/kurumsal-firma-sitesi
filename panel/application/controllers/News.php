	...
	public function save(){
        ...
        if($validate){
            if ($news_type == "image") {
                ...
                $image_600x400 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",600,400, $file_name);
                $image_738x301 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",738,301, $file_name);
                if($image_600x400 && $image_738x301){
                    $data = array(
