                ...
                <form action="<?php echo base_url("services/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-1 image_upload_container">
                            <img src="<?php echo get_picture($viewFolder,$item->img_url,"738x301"); ?>" alt="" class="img-responsive">
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea class="form-control" name="keyw" cols="30" rows="10"><?php echo $item->keyw; ?></textarea>
                        </div>
                        <div class="form-group col-md-6">
                            <label>Meta Description (Maks. 255 Karakter)</label>
                            <textarea class="form-control" name="desc" cols="30" rows="10"><?php echo $item->desc; ?></textarea>
                        </div>
                    </div>
