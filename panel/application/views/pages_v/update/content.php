            ...
            <div class="widget-body">
                <form action="<?php echo base_url("pages/update/$item->id"); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" name="page_keyw" cols="30" rows="10"><?php echo $item->page_keyw; ?></textarea>
                    </div>
                    <div class="form-group col-md-12">
                        <label>Meta Description (Maks. 255 Karakter)</label>
                        <textarea class="form-control" name="page_desc" cols="30" rows="10"><?php echo $item->page_desc; ?></textarea>
                    </div>
